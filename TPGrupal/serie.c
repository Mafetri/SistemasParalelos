...
int main(int argc, char *argv[]) {
    ...
    //El tamaño total de la matriz es el tamaño indicado más dos filas y dos columnas auxiliares	
    nrows = rows + 2;
    ncols = cols + 2;
    ...
    for (j = i; j < nrows - 1; j++) //Para las últimas filas si no están "dibujadas" en el patrón
